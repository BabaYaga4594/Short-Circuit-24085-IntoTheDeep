...
@TeleOp(name = "ScrimBotTeleOpV2")
public class ScrimBotTeleOpV2 extends OpMode {
    ...
    public void driveMechanum(double left_y, double left_x, double right_x){
        ...
        frontRight.setPower(((left_y - left_x - right_x) / maxPower) * -1);
        backLeft.setPower(((left_y - left_x + right_x) / maxPower) * -1);
        backRight.setPower(((left_y + left_x - right_x) / maxPower) * -1);
    }
